...
public static class UserErrors
{
    ...
    public static readonly CustomError InvalidConfirmPassword =
        new("User.InvalidConfirmPassword", "Confirm password is not equal to password");

    public static readonly CustomError InvalidVerificationToken =
        new("User.InvalidVerificationToken", "Invalid verification token");
    ...
    public static readonly CustomError VerificationEmailNotSent =
        new("User.VerificationEmailNotSent", "Verification email not sent");
}
